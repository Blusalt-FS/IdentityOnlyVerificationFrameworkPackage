...
Pod::Spec.new do |spec|
  ...
  spec.version = '0.0.9' # same as github tag version
  ...
  spec.source = { :git => 'https://github.com/Blusalt-FS/IdentityOnlyVerificationFrameworkPackage.git', :tag => 'v0.0.9' } # url to clone the framework, tag may be same as spec.version
  ...
  spec.pod_target_xcconfig = {'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => '$(ARCHS_STANDARD)','VALID_ARCHS' => 'arm64',}
  spec.user_target_xcconfig = {'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => '$(ARCHS_STANDARD)','VALID_ARCHS' => 'arm64',}
end

...
Pod::Spec.new do |spec|
  ...
  spec.version = '0.0.2' # same as github tag version
  ...
  spec.source = { :git => 'https://github.com/Blusalt-FS/IdentityOnlyVerificationFrameworkPackage.git', :tag => 'v0.0.2' } # url to clone the framework, tag may be same as spec.version

...
Pod::Spec.new do |spec|
  ...
  spec.version = '0.0.5' # same as github tag version
  ...
  spec.source = { :git => 'https://github.com/Blusalt-FS/IdentityOnlyVerificationFrameworkPackage.git', :tag => 'v0.0.5' } # url to clone the framework, tag may be same as spec.version
  ...
  spec.xcconfig = {
    ...
    'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'x86',
